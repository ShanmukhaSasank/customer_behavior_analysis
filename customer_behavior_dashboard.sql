...
round(sum(purchase_amount),2) as total_revenue, count(customer_id)
from customer
...
round(100 * sum(case when discount_applied = 'Yes' then 1 else 0 end)/count(*)) as discount_rate from customer
group by item_purchased
